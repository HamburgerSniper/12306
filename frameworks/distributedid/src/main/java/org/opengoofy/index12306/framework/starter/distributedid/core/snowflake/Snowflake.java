...
public class Snowflake implements Serializable, IdGenerator {
    ...
    /**
     * @description 默认的起始时间，为Thu, 04 Nov 2010 01:42:54 GMT
     */
    private static long DEFAULT_TWEPOCH = 1288834974657L;
    /**
     * @description 默认回拨时间，2S
     */
    ...
    /**
     * @description 允许的时钟回拨毫秒数
     */
    private final long timeOffset;

    /**
     * @description 当在低频模式下时，序号始终为0，导致生成ID始终为偶数<br>
    ...
    /**
     * @description 自增序号，当高频模式下时，同一毫秒内生成N个ID，则这个序号在同一毫秒下，自增以避免ID重复。
     */
    ...
    /**
     * @description 构造，使用自动生成的工作节点ID和数据中心ID
     */
    public Snowflake() {
     ...
     * @return 所属机器的id
     * @description 根据Snowflake的ID，获取机器id
     */
     ...
     * @param id snowflake算法生成的id
     * @return 所属数据中心
     * @description 根据Snowflake的ID，获取数据中心id
     */
     ...
     * @param id snowflake算法生成的id
     * @return 生成的时间
     * @description 根据Snowflake的ID，获取生成时间
     */
